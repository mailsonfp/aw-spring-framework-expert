...
public class UsuarioController {
	...
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter, BindingResult result, @PageableDefault(size = 3) Pageable pageable, HttpServletRequest httpServletRequest) {
		...
		PageWrapper<Usuario> paginaWrapper = new PageWrapper<>(usuarioService.pesquisar(usuarioFilter, pageable), httpServletRequest);
	...
	public ModelAndView editar(@PathVariable Long codigo) {
		Usuario usuario = usuarioService.buscarUsuarioPorCodigo(codigo);
